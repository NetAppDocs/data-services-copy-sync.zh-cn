...
---
= 使用NetApp Copy and Sync中的数据传输加密同步 NFS 数据
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
如果您的企业有严格的安全策略，您可以使用NetApp Copy and Sync中的数据传输加密来同步 NFS 数据。此功能支持从一个 NFS 服务器到另一个 NFS 服务器以及从Azure NetApp Files到Azure NetApp Files。
