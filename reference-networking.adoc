...
summary: NetApp Copy and Sync的网络包括数据代理组与源位置和目标位置之间的连接，以及通过端口 443 来自数据代理的出站互联网连接。 
---
= NetApp Copy and Sync 的网络要求
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NetApp Copy and Sync的网络包括数据代理组与源位置和目标位置之间的连接，以及通过端口 443 来自数据代理的出站互联网连接。
...
| \ https://api.bluexp.netapp.com \ https://netapp-cloud-account.auth0.com | 当您使用分类来选择新同步关系的源文件时，请联系NetApp Data Classification。 
